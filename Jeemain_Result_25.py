...
def Data_Xpath_Elements():
    ...
    v_Mathematics_BARC = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[3]/td[2]').text
    v_Aptitude_BARC = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[4]/td[2]').text
    v_Drawing_BARC = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[5]/td[2]').text
    v_Total_BARC = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[6]/td[2]').text
    v_TotinWords_BARC = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[7]/td[2]').text

    v_Mathematics_BPLAN = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[3]/td[4]').text
    v_Aptitude_BPLAN = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[4]/td[4]').text
    v_PlanningbasedQA_BPLAN = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[5]/td[4]').text
    v_Total_BPLAN = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[6]/td[4]').text
    v_TotinWords_BPLAN = driver.find_element(By.XPATH, '//*[@id="tableToPrint"]/div[2]/div/div/table/tbody/tr[5]/td/table/tbody/tr[7]/td[4]').text

    insert_stu_dtls = \
                "INSERT INTO O_JEEMAINS_RES_BARCH_BPLAN_25 (ADMNO, APPNO, ROLLNO_SESS1, CANDIDATE_NAME, DOB, GENDER, MOTHER, FATHER, CATEGORY, PWBD, STATEOFELIGIBILITY, NATIONALITY, MATHEMATICS_BARC, APPTITUDE_BARC, DRAWING_BARC, TOTAL_BARC, TOTAL_IN_WORDS_BARC, MATHEMATICS_BPLAN, APPTITUDE_BPLAN, PLANNING_BASED_QA_BPLAN, TOTAL_BPLAN, TOTAL_IN_WORDS_BPLAN, PROCESS_STATUS, PROCESS_USER) \
                VALUES ('" + str(v_AdmNo) + "', '" + str(v_AppNo) + "', '" + str(v_RollNo) + "', '" + str(v_CName) + "', '" + str(v_DoB) + "', '" + str(v_Gender) + "', '" + str(v_MName) + "', '" + str(v_FName) + "', '" + str(v_Category) + "', '" + str(v_PwBD) + "', '" + str(v_StateofEligibility) + "', '" + str(v_Nationality) + "', '" + v_Mathematics_BARC + "', '" + v_Aptitude_BARC + "', '" + v_Drawing_BARC + "', '" + v_Total_BARC + "', '" + str(v_TotinWords_BARC) + "', '" + v_Mathematics_BPLAN + "', '" + v_Aptitude_BPLAN + "', '" + v_PlanningbasedQA_BPLAN + "', '" + v_Total_BPLAN + "', '" + str(v_TotinWords_BPLAN) + "', 'D', '" + str(v_PROCESS_USER) + "')"      
    cur.execute(insert_stu_dtls) # Execute an INSERT statement

    update_IpStatus = "UPDATE I_JEEMAINS_RESULTS_PWD_25 SET PROCESS_STATUS_BARC_BPLAN = 'D', PROCESS_USER_BARC_BPLAN = '"+ str(v_PROCESS_USER) +"', CREATEDDATE = SYSDATE WHERE APPNO = '"+ str(v_appno) +"'"
...
for row in res:
    ...
    try:  
        driver.get("https://examinationservices.nic.in/resultservices/JEEMAIN2025S1P2/Login")
            ...
            while attempts < max_attempts and not login_successful:
                ...
                try:
                    ...
                    if v_invalid == "Invalid Application Number/Password":        
                        update_IpStatus = "UPDATE I_JEEMAINS_RESULTS_PWD_25 SET PROCESS_STATUS_BARC_BPLAN = 'Invalid', PROCESS_USER_BARC_BPLAN = '"+ str(v_PROCESS_USER) +"', CREATEDDATE = SYSDATE, ERROR_MESSAGE = '"+ str(v_invalid) +"' WHERE APPNO = '"+ str(v_appno) +"'"
                        cur.execute(update_IpStatus) # Execute an UPDATE statement
                        conn.commit()
                        login_successful=True
                    else:
